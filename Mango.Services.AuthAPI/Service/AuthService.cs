...
namespace eComm.Services.AuthAPI.Service
{
    public class AuthService : IAuthService
    {
        ...
        {
            var user = _db.ApplicationUsers.FirstOrDefault(e => e.Email.ToLower() == email.ToLower());
            if (user != null)
            {
        ...
        {
            var user = _db.ApplicationUsers.FirstOrDefault(e =>
